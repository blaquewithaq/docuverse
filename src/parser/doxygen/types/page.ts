import type {
  ...
  DoxygenPageBool,
  DoxygenPageCheck,
  DoxygenPageCompoundKind,
  DoxygenPageGraphRelation,
  DoxygenPageHighlightClass,
  DoxygenPageImageKind,
  DoxygenPageLanguage,
  DoxygenPageMemberKind,
  DoxygenPageOl,
  DoxygenPageParamDir,
  DoxygenPageParamListKind,
  DoxygenPagePlantumlEngine,
  DoxygenPageProtectionKind,
  DoxygenPageRefKind,
  DoxygenPageRefQualifierKind,
  DoxygenPageSectionKind,
  DoxygenPageSimpleSectKind,
  DoxygenPageVerticalAlign,
  DoxygenPageVirtualKind,
} from "./page-enums"
